...
namespace BasicFacebookFeatures
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.BackColor = ColorPalette.sr_FacebookBlue; // USE PALETTE
            ...
            panelBottom = new Panel()
            {
                ...
                Height = 60,
                BackColor = ColorPalette.sr_FacebookBlue // USE PALETTE
            };
            ...
            toggleBackground = new Panel()
            {
                ...
                BackColor = ColorPalette.sr_LightModeToggleOffBackground, // USE PALETTE
            ...
            toggleCircle = new Panel()
            {
                ...
                BackColor = Color.White, // Will be set to ColorPalette.DarkModeToggleCircle/Color.White in applyDarkMode
                BorderStyle = BorderStyle.FixedSingle
            };
        ...
        private void createAlbumsSection(TabPage parent)
        {
            ...
            linkAlbums = new LinkLabel()
            {
                ...
                LinkColor = ColorPalette.sr_FacebookBlue, // Will be overridden in applyDarkMode
                AutoSize = false
            };
